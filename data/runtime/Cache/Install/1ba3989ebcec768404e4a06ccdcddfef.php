...
<link rel="stylesheet" href="/lun/public/simpleboot/themes/flat/theme.min.css" />
<link rel="stylesheet" href="/lun/public/install/css/install.css" />
<link rel="stylesheet" href="/lun/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css" />
...
<body>
	...
	<div class="version"><?php echo (SIMPLEWIND_CMF_VERSION); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="/lun/index.php?g=install&a=step4" method="post">
				...
				<div class="bottom text-center">
					<a href="/lun/index.php?g=install&a=step2" class="btn btn-primary">上一步</a>
					<button type="submit" class="btn btn-primary">创建数据</button>
				</div>
			</form>
		</section>
		<script src="/lun/public/js/jquery.js"></script>
		<script src="/lun/public/js/validate.js"></script>
		<script src="/lun/public/js/ajaxForm.js"></script>
		<script>
			function TestDbPwd() {
				...
				var url = "/lun/index.php?g=install&a=testdbpwd";
				$.ajax({
					type : "POST",
					url : url,
					data : data,
