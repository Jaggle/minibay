...
<html>
	<head>
		...
		<link href="/lun/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/lun">ThinkCMF <?php echo L('ADMIN_CENTER');?></a></h1>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/lun/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
<script src="/lun/public/js/wind.js"></script>
<script src="/lun/public/js/jquery.js"></script>
<script type="text/javascript" src="/lun/public/js/common.js"></script>
<script>
;(function(){
