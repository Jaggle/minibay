...
<head>
    ...
    <link href="/lun/public/js/artDialog/skins/default.css" rel="stylesheet" />
...
.table_list tr.expanded td .expander{
	background: url(/lun/admin/themes/simplebootx/Public/assets/images/tv-collapsable.gif) center center no-repeat;
}
.table_list tr.collapsed td .expander{
	background: url(/lun/admin/themes/simplebootx/Public/assets/images/tv-expandable.gif) center center no-repeat;
}
</style>
<script src="/lun/public/js/common.js"></script>
<script>
$(function(){
    $(".show_sub").click(function(){
        $(this).attr("src",function(){
            if(this.src == '/lun/admin/themes/simplebootx/Public/assets/images/tv-expandable.gif'){
                return '/lun/admin/themes/simplebootx/Public/assets/images/tv-collapsable.gif';
            } else {
                return '/lun/admin/themes/simplebootx/Public/assets/images/tv-expandable.gif';
            }
        });
